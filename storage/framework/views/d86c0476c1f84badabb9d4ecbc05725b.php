...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
    <div class="container">
      ...
      <div class="btn-group btn-group-auth">
        ...
        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary">Zaloguj się</a>
        <a href="<?php echo e(route('register')); ?>" class="btn btn-secondary">Zarejestruj się</a>
      </div>
    </div>
  </nav>
      ...
      <div class="col-md-4">
        <div class="card course-card">
          ...
          <div class="card-body">
            ...
            <a href="<?php echo e(route('rezerwacja', ['course' => 'Angielski - podstawowy'])); ?>" class="btn btn-primary">Zapisz się na kurs</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card course-card">
          ...
          <div class="card-body">
            ...
            <a href="<?php echo e(route('rezerwacja', ['course' => 'Hiszpański - średniozaawansowany'])); ?>" class="btn btn-primary">Zapisz się na kurs</a>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card course-card">
          ...
          <div class="card-body">
            ...
            <a href="<?php echo e(route('rezerwacja', ['course' => 'Francuski - początkujący'])); ?>" class="btn btn-primary">Zapisz się na kurs</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <a href="<?php echo e(route('oferta')); ?>" class="btn btn-primary">Zobacz wszystkie kursy</a>
  </div>
  <div class="container mb-5">
  ...
  <div class="container mb-5">
    ...
    <div class="row">
<?php /**PATH D:\zadania\aplikacje\language_courses\resources\views/home.blade.php ENDPATH**/ ?>