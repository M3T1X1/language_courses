    ...
    <form>
      ...
      <div class="mb-3">
        ...
        <select class="form-select" id="course" required>
          ...
          <option {{ $courseName == 'Angielski - podstawowy' ? 'selected' : '' }}>Angielski - podstawowy</option>
          <option {{ $courseName == 'Hiszpański - średniozaawansowany' ? 'selected' : '' }}>Hiszpański - średniozaawansowany</option>
          <option {{ $courseName == 'Francuski - początkujący' ? 'selected' : '' }}>Francuski - początkujący</option>
        </select>
      </div>
      <div class="mb-3">
